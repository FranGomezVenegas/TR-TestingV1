...
import { ConfigCalendar } from '../../trazit-models/test-config-WaterMonitoring-ProgramList-ConfigCalendar';
...
const commonTests = () => {
    test('Trazit-WaterMonitoring-ProgramList-ConfigCalendar-Open', async ({ page }, testInfo) => {
        await page.pause();
        await page.pause();
        await page.getByLabel(ConfigCalendar.buttonName).click();
        await page.pause();
        await page.pause();
        await testInfo.attach(ConfigCalendar.screenShotsSamplingPointsMap, {
