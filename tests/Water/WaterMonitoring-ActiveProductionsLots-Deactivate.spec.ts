...
import { Deactivate } from '../../trazit-models/test-config-WaterMonitoring-ActiveProductionsLots-Deactivate'
...
const commonTests = () => {
  test('Trazit-WaterMonitoring-ActiveProductionsLots-Deactivate-Accept', async ({ page }, testInfo) => {
      await page.pause();
      let afterEachData = {
        textInNotif1:"",
        textInNotif2:"",
      ...
      await page.getByText(Deactivate.selectName, { exact: true }).click();
      await page.pause();
      await page.pause();
      await testInfo.attach(Deactivate.screenShotsSelect, {
        body: await page.screenshot({ fullPage: true }),
        contentType: ConfigSettingsAlternative.screenShotsContentType
      });
      await page.getByLabel(Deactivate.buttonDeactivate).click();
      ...
      await page.pause();
      await page.pause();
      await testInfo.attach(Deactivate.screenShotsJustificationPhraseEmpty, {
        body: await page.screenshot({ fullPage: true }),
        contentType: ConfigSettingsAlternative.screenShotsContentType
      });
      await page.getByRole('combobox', { name: Deactivate.fldJustificationPhrase.label }).click();
      await page.pause();
      await page.pause();
      await page.getByRole('combobox', { name: Deactivate.fldJustificationPhrase.label }).fill(Deactivate.fldJustificationPhrase.value);
      await page.pause();
      await page.pause();
      await testInfo.attach(Deactivate.screenShotsJustificationPhraseFilled, {
        body: await page.screenshot({ fullPage: true }),
        contentType: ConfigSettingsAlternative.screenShotsContentType
      });      
      await page.pause();
  ...
  test('Trazit-WaterMonitoring-ActiveProductionsLots-Deactivate-Cancel', async ({ page }, testInfo) => {
    await page.pause();
    await page.getByText(Deactivate.selectName, { exact: true }).click();
    await page.pause();
    await page.pause();
