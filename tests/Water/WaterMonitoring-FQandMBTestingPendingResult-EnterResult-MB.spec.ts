...
const commonTests = () => {
    test('Trazit-WaterMonitoring-FQandMBTestingPendingResult-MB-EnterResult-Accept', async ({ page }, testInfo) => {
        let afterEachData = {
            textInNotif1:"",
            textInNotif2:"",
            textInNotif3:"",
    ...
    test('Trazit-WaterMonitoring-FQandMBTestingPendingResult-MB-EnterResult-Cancel', async ({ page }, testInfo) => {
        let afterEachData = {
            textInNotif1:"",
            textInNotif2:"",
            textInNotif3:"",
    ...
    test('Trazit-WaterMonitoring-FQandMBTestingPendingResult-MB-ReEnterResult-Accept', async ({ page }, testInfo) => {
        let afterEachData = {
            textInNotif1:"",
            textInNotif2:"",
            textInNotif3:"",
    ...
    test('Trazit-WaterMonitoring-FQandMBTestingPendingResult-MB-ReEnterResult-Cancel', async ({ page }, testInfo) => {
        let afterEachData = {
            textInNotif1:"",
            textInNotif2:"",
            textInNotif3:"",
