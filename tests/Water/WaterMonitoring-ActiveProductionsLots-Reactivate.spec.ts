...
import { Reactivate } from '../../trazit-models/test-config-WaterMonitoring-ActivateProductionsLots-Reactivate';
import { JustificationPhrase} from '../1TRAZiT-Commons/1TRAZiT-ConfirmDialogs/test-config-JustificationPhrase';
...
const commonTests = () => {
  test('Trazit-WaterMonitoring-ActiveProductionsLots-Reactivate-Accept', async ({ page }, testInfo) => {
      await page.pause();
      let afterEachData = {
        textInNotif1:"",
        textInNotif2:"",
      ...
      await page.pause();
      await page.pause();
      await testInfo.attach(Reactivate.screenShotsReactivate, {
        body: await page.screenshot({ fullPage: true }),
        contentType: ConfigSettingsAlternative.screenShotsContentType
      });
      await page.pause();
      await page.getByLabel(Reactivate.buttonRefresh).click();
      await page.pause();
      await page.pause();
      await testInfo.attach(Reactivate.screenShotsRefresh, {
        body: await page.screenshot({ fullPage: true }),
        contentType: ConfigSettingsAlternative.screenShotsContentType
      });
      await page.getByRole('button', { name: Reactivate.buttonAccept.label }).click();
      await page.pause();
      await page.pause();
      await testInfo.attach(Reactivate.screenShotsJustificationPhraseEmpty, {
        body: await page.screenshot({ fullPage: true }),
        contentType: ConfigSettingsAlternative.screenShotsContentType
      });
      await page.getByRole('combobox', { name: Reactivate.fldJustificationPhrase.label }).click();
      await page.pause();
      await page.pause();
      await page.getByRole('combobox', { name: Reactivate.fldJustificationPhrase.label }).fill(Reactivate.fldJustificationPhrase.value);
      await page.pause();
      await page.pause();
      await testInfo.attach(Reactivate.screenShotsJustificationPhraseFilled, {
        body: await page.screenshot({ fullPage: true }),
        contentType: ConfigSettingsAlternative.screenShotsContentType
      });
      await page.getByRole('button', { name: Reactivate.buttonAccept.label }).click();
  ...
  test('Trazit-WaterMonitoring-ActiveProductionsLots-Reactivate-Cancel', async ({ page }, testInfo) => {
      await page.pause();
      await page.getByLabel(Reactivate.buttonReactivate).click();
      await page.pause();
      await page.pause();
      ...
      await page.getByRole('button', { name: Reactivate.buttonCancel.label }).click();
      await page.pause();
      await page.pause();
