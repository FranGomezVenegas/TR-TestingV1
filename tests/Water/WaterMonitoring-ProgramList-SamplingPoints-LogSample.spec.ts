...
import { SamplingPoints } from '../../trazit-models/test-config-WaterMonitoring-ProgramList-SamplingPoints';
import { LogSample } from '../../trazit-models/test-config-WaterMonitoring-ProgramList-SamplingPoints-LogSample';
...
const commonTests = () => {
    test('Trazit-WaterMonitoring-ProgramList-SamplingPoints-LogSample-Accept', async ({ page }, testInfo) => {
        let afterEachData = {
            textInNotif1:"",
            textInNotif2:"",
            textInNotif3:"",
        ...
        await page.pause();
        await page.pause();
        await page.getByLabel(SamplingPoints.buttonName).click();
        await page.pause();
        await page.pause();
        ...
        await page.pause();
        await page.getByText(LogSample.selectArea).first().click();
        await page.pause();
        await page.pause();
        await testInfo.attach(LogSample.screenShotsSelectArea, {
            body: await page.screenshot({ fullPage: true }),
            contentType: ConfigSettingsAlternative.screenShotsContentType
        });
        await page.pause();
        await page.getByRole('combobox', { name: LogSample.fldShift.label }).click();
        await page.pause();
        await page.pause();
        ...
        await page.pause();
        await page.getByRole('option', { name: LogSample.fldShift.option }).click();
        await page.pause();
        await page.pause();
        await testInfo.attach('', {
            body: await page.screenshot({ fullPage: true }),
        ...
        await page.getByRole('button', { name: LogSample.buttonLogSample }).click();
        await page.pause();
        await page.pause();
    ...
    test('Trazit-WaterMonitoring-ProgramList-SamplingPoints-LogSample-Cancel', async ({ page }, testInfo) => {
        await page.pause();
        await page.pause();
        await page.getByLabel(SamplingPoints.buttonName).click();
        await page.pause();
        ...
        await page.getByRole('button', { name: LogSample.buttonCancel }).click();
        await page.pause();
        await page.pause();
