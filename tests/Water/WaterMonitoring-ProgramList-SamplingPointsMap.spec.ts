...
import { SamplingPointsMap } from '../../trazit-models/test-config-WaterMonitoring-ProgramList-SamplingPointsMap';
...
const commonTests = () => {
    test('Trazit-WaterMonitoring-ProgramList-SamplingPointsMap-Open', async ({ page }, testInfo) => {
        await page.pause();
        await page.pause();
        await page.getByLabel(SamplingPointsMap.buttonName).click();
        await page.pause();
        await page.pause();
        await testInfo.attach(SamplingPointsMap.screenShotsSamplingPointsMap, {
