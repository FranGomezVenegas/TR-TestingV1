...
// import { addAttachment as dataForTestFromFile } from '../../trazit-models/test-config-instrumentsBalances-addAttachment';
// import { addAttachment as dataForTestFromFile } from '../../trazit-models/test-config-instrumentsCG-addAttachment';
import { addAttachment as dataForTestFromFile } from '../../trazit-models/test-config-instrumentsEventsInProgress-addAttachment';
...
import { clickElementByText, justificationPhrase, fillUserCredentials, clickAcceptButton, clickButtonAcceptCancel, attachScreenshot } from '../1TRAZiT-Commons/actionsHelper';
...
const commonTests = async (ConfigSettings, page, testInfo) => { 
        ...
        if (ConfigSettings && ConfigSettings.dataForTest) {
            ...
            addAttachment = dataForTestFromFile; // Make sure to parse the valid JSON string
