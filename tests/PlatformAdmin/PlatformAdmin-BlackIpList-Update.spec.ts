...
// import { Update } from '../../trazit-models/test-config-PlatformAdmin-BlackIpList-Update';
...
// const commonTests = () => {
//     test('Trazit-PlatformAdmin-BlackIpList-Update-Accept', async ({ page }, testInfo) => {
//         let afterEachData = {
//             textInNotif1:"",
//             textInNotif2:"",
//             textInNotif3:"",
...
//     test('Trazit-PlatformAdmin-BlackIpList-Update-Cancel', async ({ page }, testInfo) => {
//         // Crear instancias de Logger y NetworkInterceptor
//         const logger = new Logger();
//         const networkInterceptor = new NetworkInterceptor();
