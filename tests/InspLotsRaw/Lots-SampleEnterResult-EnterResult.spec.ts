...
import { EnterResult} from '../../trazit-models/test-config-Lots-SampleEnterResult-EnterResult';
...
const commonTests = () => {
  test('Trazit-Lots-SampleEnterResult-EnterResult-Accept', async ({ page }, testInfo) => {
    await page.pause();
    let afterEachData = {
      textInNotif1:"",
      textInNotif2:"",
    ...
    await page.pause();
    await page.getByText(EnterResult.selectSampleID, { exact: true }).click();
    await page.pause();
    await page.pause();
    await testInfo.attach(EnterResult.screenShotsSelectSampleID, {
    ...
    test('Trazit-Lots-SampleEnterResult-ReenterResult-Accept', async ({ page }, testInfo) => {
