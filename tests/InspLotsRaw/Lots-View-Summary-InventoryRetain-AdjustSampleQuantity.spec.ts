...
import { AdjustSampleQuantity } from '../../trazit-models/test-config-Lots-View-Summary-InventoryRetain-AdjustSampleQuantity';
...
const commonTests = () => {
    test('Trazit-LotsView-Search-Summary-AdjustSampleQuantity-Accept', async ({ page }, testInfo) => {
        ...
        await page.pause();
        await page.getByLabel(AdjustSampleQuantity.fldQuantity.label).click();
        await page.pause();
        await page.pause();
        await page.getByLabel(AdjustSampleQuantity.fldQuantity.label).fill(AdjustSampleQuantity.fldQuantity.value);
        await page.pause();
        await page.pause();
