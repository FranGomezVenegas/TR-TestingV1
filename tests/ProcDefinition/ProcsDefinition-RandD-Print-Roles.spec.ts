...
// import { Print } from '../../trazit-models/test-config-ProcsDefinition-RandD-Print-Roles';
...
// const commonTests = () => {
//     test('Trazit-ProceduresDefinition-RandD-Print-Roles-Vertical', async ({ page, context }, testInfo) => {
//         await page.pause();
...
//             page.getByLabel(Print.buttonName).nth(1).click(), // Click en el botón de imprimir
//         ]);
...
//     test('Trazit-ProceduresDefinition-RandD-Print-Roles-Horizontal', async ({ page, context }, testInfo) => {
//         await page.pause();
        
//         // Hacer clic en el botón de imprimir para abrir el diálogo de impresión en una nueva pestaña
//         const [newPage] = await Promise.all([
//             context.waitForEvent('page'), // Esperar a que se abra una nueva página
//             page.getByLabel('print').nth(0).click(), // Click en el botón de imprimir
//         ]);
