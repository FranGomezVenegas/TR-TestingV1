...
import { Print } from '../../trazit-models/test-config-ProcsDefinition-RandD-Print-Users';
...
const commonTests = () => {
    test('Trazit-ProceduresDefinition-RandD-Print-Users-Vertical', async ({ page, context }, testInfo) => {
        await page.pause();
    
        // Obtener el botón de imprimir y asegurar que esté visible en la pantalla
        const printButton = page.getByLabel(Print.buttonName).nth(2);
    ...
    test('Trazit-ProceduresDefinition-RandD-Print-Users-Horizontal', async ({ page, context }, testInfo) => {
        await page.pause();
