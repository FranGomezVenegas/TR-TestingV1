...
const commonTests = () => {
    test('Trazit-ProceduresDefinition-Instrument-Open', async ({ page }, testInfo) => {
        page.pause();
        page.pause();
    });


    test('Trazit-ProceduresDefinition-Instrument-Home', async ({ page }, testInfo) => {
      page.pause();
      page.pause();
...
test.describe('Desktop Mode', () => {
    test.beforeEach(async ({ page }, testInfo) => {
        ...
        await moduleWindow.openModule(MenuInstrumentsControl.Instruments.main.name, testInfo, ConfigSettings);
