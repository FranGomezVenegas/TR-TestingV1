...
const commonTests = () => {
    test('Trazit-ProceduresDefinition-Demo-Open', async ({ page }, testInfo) => {
        page.pause();
        page.pause();
    });

    test('Trazit-ProceduresDefinition-Demo-Home', async ({ page }, testInfo) => {
      page.pause();
      page.pause();
...
test.describe('Desktop Mode', () => {
    test.beforeEach(async ({ page }, testInfo) => {
        ...
        await moduleWindow.openModule('Demo', testInfo, ConfigSettings);
