...
const commonTests = () => {
    test('Trazit-ProceduresDefinition-Mon_water-Open', async ({ page }, testInfo) => {
        page.pause();
        page.pause();
    });
    
    
    test('Trazit-ProceduresDefinition-Mon_water-Home', async ({ page }, testInfo) => {
      page.pause();
      page.pause();
...
test.describe('Desktop Mode', () => {
    test.beforeEach(async ({ page }, testInfo) => {
        ...
        await moduleWindow.openModule(platformMenuNames.WaterMonitoring.main.name, testInfo, ConfigSettings);
