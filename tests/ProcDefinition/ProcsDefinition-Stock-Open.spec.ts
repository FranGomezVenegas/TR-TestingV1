...
const commonTests = () => {
    test('Trazit-ProceduresDefinition-Stock-Open', async ({ page }, testInfo) => {
        page.pause();
        page.pause();
    });

    test('Trazit-ProceduresDefinition-Stock-Home', async ({ page }, testInfo) => {
      page.pause();
      page.pause();
...
test.describe('Desktop Mode', () => {
    test.beforeEach(async ({ page }, testInfo) => {
        ...
        await moduleWindow.openModule(MenuStock.Stock.main.name, testInfo, ConfigSettings);
