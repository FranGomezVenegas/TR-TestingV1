...
const commonTests = () => {
    test('Trazit-ProceduresDefinition-Mb_em-Open', async ({ page }, testInfo) => {
        page.pause();
        page.pause();
    });

    test('Trazit-ProceduresDefinition-Mb_em-Home', async ({ page }, testInfo) => {
      page.pause();
      page.pause();
...
test.describe('Desktop Mode', () => {
    test.beforeEach(async ({ page }, testInfo) => {
        ...
        await moduleWindow.openModule(MenuMicroEM.MicroEM.main.name, testInfo, ConfigSettings);
