...
// import { Print } from '../../trazit-models/test-config-ProcsDefinition-RandD-Print-UserRoles';
...
// const commonTests = () => {
//     test('Trazit-ProceduresDefinition-RandD-Print-UserRoles-Vertical', async ({ page, context }, testInfo) => {
//         await page.pause();
    
//         // Obtener el botón de imprimir y asegurar que esté visible en la pantalla
//         const printButton = page.getByLabel(Print.buttonName).nth(3);
//         await printButton.scrollIntoViewIfNeeded(); // Hacer scroll para que el botón esté en vista si es necesario
//         await page.pause();
//         await page.pause();
...
//             printButton.click(), // Hacer clic en el botón de imprimir
//         ]);
//         await page.pause();
//         await page.pause();
...
//         await newPage.waitForTimeout(5000); // Ajusta el tiempo según sea necesario
...
//     test('Trazit-ProceduresDefinition-RandD-Print-UserRoles-Horizontal', async ({ page, context }, testInfo) => {
//         await page.pause();

//         // Obtener el botón de imprimir y asegurar que esté visible en la pantalla
//         const printButton = page.getByLabel(Print.buttonName).nth(3);
//         await printButton.scrollIntoViewIfNeeded(); // Hacer scroll para que el botón esté en vista/visible si es necesario
