...
const commonTests = () => {
    test('Trazit-MicroEM-PendingSampling-SetSamplingDate', async ({ page }, testInfo) => {
        await page.pause();
        let afterEachData = {
            textInNotif1:"",
            textInNotif2:"",
        ...
        await page.pause();
        await page.getByText(SetSamplingDate.selectSampleID, { exact: true }).click();
        await page.pause();
        await page.pause();
        ...
        await page.pause();
        await page.getByText(SampleAudit.buttonSampleAudit, { exact: true }).click();
        await page.pause();
        await page.pause();
