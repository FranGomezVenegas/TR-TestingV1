...
import { ConfigCalendar } from '../../trazit-models/test-config-MicroEM-Program-ConfigCalendar';
...
const commonTests = () => {
    test('Trazit-MicroEM-Program-ConfigCalendar-Open', async ({ page }, testInfo) => {
      await page.pause();
      await page.pause();
      await page.getByLabel(ConfigCalendar.buttonName).click();
      await page.pause();
      await page.pause();
      await testInfo.attach(ConfigCalendar.screenShotsClickButtonName, {
