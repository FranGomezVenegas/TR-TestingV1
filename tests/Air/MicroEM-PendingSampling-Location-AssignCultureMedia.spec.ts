...
import { CultureMedia } from '../../trazit-models/test-config-MicroEM-PendingSampling-AssignCultureMedia';
...
const commonTests = () => {
    test('Trazit-MicroEM-PendingSampling-AssignCultureMedia-Accept', async ({ page }, testInfo) => {
        await page.pause();
        let afterEachData = {
            textInNotif1:"",
            textInNotif2:"",
        ...
        await page.pause();
        await page.getByText(CultureMedia.selectIdSample, { exact: true }).click();
        await page.pause();
        await page.pause();
        await testInfo.attach(CultureMedia.screenShotsSelectSampleID, {
            body: await page.screenshot({fullPage: true }), 
            contentType: ConfigSettingsAlternative.screenShotsContentType
        });
        await page.pause();
        await page.getByLabel(CultureMedia.buttonName, { exact: true }).click();
        await page.pause();
        await page.pause();
        ...
        await page.pause();
        await page.getByLabel(CultureMedia.buttonAccept, { exact: true }).click();
        await page.pause();
        await page.pause();
        await testInfo.attach("", {
            body: await page.screenshot({ fullPage: true }),
        ...
        afterEachData.textInNotif1=CultureMedia.textInNotif1
        afterEachData.textInNotif2=CultureMedia.textInNotif2
        afterEachData.textInNotif3=CultureMedia.textInNotif3
        ...
        if (viewportWidth >= 1024) {
            ...
            await testInfo.attach(CultureMedia.screenformNotifications, {
            body: await page.screenshot({ fullPage: true }),
            contentType: ConfigSettingsAlternative.screenShotsContentType
            });
            const notificationDiv = await page.locator(MenuInstrumentsControl.Notification.main.pageElementdiv).first();
            if (notificationDiv !== null) {
            await testInfo.attach(CultureMedia.screenformLastNotifications, {
    ...
    test('Trazit-MicroEM-PendingSampling-AssignCultureMedia-Cancel', async ({ page }, testInfo) => {
        await page.pause();
        await page.getByText(CultureMedia.selectIdSample, { exact: true }).click();
        await page.pause();
        await page.pause();
