...
import { createInvestigation } from '../../trazit-models/test-config-instruments-Deviantions-CreateInvestigation';
...
const commonTests = () => {
    test('Trazit-Instruments-Deviations-PendingDecision-Open', async ({ page }, testInfo) => {
        await page.pause();
        await page.getByLabel(createInvestigation.buttonPendingDecision).click();
        await page.pause();
    ...
    test('Trazit-Instruments-Deviations-PendingDecision-CreateInvestigation', async ({ page }, testInfo) => {
        let afterEachData = {
            textInNotif1: "",
            textInNotif2: "",
            textInNotif3: "",
        ...
        await page.pause();
        await page.pause();
        await testInfo.attach(createInvestigation.screenShotsButtonPendingDecision, {
            body: await page.screenshot({ fullPage: true }), contentType: ConfigSettingsAlternative.screenShotsContentType
        });
        await page.pause();
        await page.getByText(createInvestigation.selectName, { exact: true }).click();
        await page.pause();
        await page.pause();
        await testInfo.attach(createInvestigation.screenShotsSelectLotName, {
            body: await page.screenshot({ fullPage: true }), contentType: ConfigSettingsAlternative.screenShotsContentType
        });
        await page.pause();
        await page.getByLabel(createInvestigation.buttonName).click();
        await page.pause();
        await page.pause();
        await testInfo.attach(createInvestigation.screenShotsButtonCreateInvestigation, {
            body: await page.screenshot({ fullPage: true }), contentType: ConfigSettingsAlternative.screenShotsContentType
        });
        await page.pause();
        ...
        afterEachData.textInNotif1 = createInvestigation.textInNotif1;
        afterEachData.textInNotif2 = createInvestigation.textInNotif2;
        afterEachData.textInNotif3 = createInvestigation.textInNotif3;
        ...
        if (viewportWidth >= 1024) {
            ...
            await testInfo.attach(createInvestigation.screenformNotifications, {
            ...
            if (notificationDiv !== null) {
                await testInfo.attach(createInvestigation.screenformLastNotifications, {
