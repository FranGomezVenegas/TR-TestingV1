...
import {CreateInvestigations} from '../../trazit-models/test-config-Instruments-ActiveInstruments-CreateInvestigations'
...
const commonTests = () => {
  test('Trazit-Instruments-CreateInvestigations', async ({ page }, testInfo) => {
    await page.pause();
    let afterEachData = {
      textInNotif1:"",
      textInNotif2:"",
    ...
    const selectInstruments = page.getByText(CreateInvestigations.selectInstruments, { exact: true });
    ...
    await page.pause();
    await page.pause();
    await testInfo.attach(CreateInvestigations.screenShotsSelect, {
        body: await page.screenshot({ fullPage: true }), 
        contentType: ConfigSettingsAlternative.screenShotsContentType
    });
    
    await page.getByLabel(CreateInvestigations.buttonName).click();
    await page.pause();
    await page.pause();
    await testInfo.attach(CreateInvestigations.screenShotsButton, {
        body: await page.screenshot({ fullPage: true }), 
        contentType: ConfigSettingsAlternative.screenShotsContentType
    });
    ...
    afterEachData.textInNotif1=CreateInvestigations.textInNotif1
    afterEachData.textInNotif2=CreateInvestigations.textInNotif2
    afterEachData.textInNotif3=CreateInvestigations.textInNotif3
      ...
      if (viewportWidth >= 1024) {
          ...
          await testInfo.attach(CreateInvestigations.screenformNotifications, {
          body: await page.screenshot({ fullPage: true }),
          contentType: ConfigSettingsAlternative.screenShotsContentType
          });
          const notificationDiv = await page.locator(MenuInstrumentsControl.Notification.main.pageElementdiv).first();
          if (notificationDiv !== null) {
          await testInfo.attach(CreateInvestigations.screenformLastNotifications, {
