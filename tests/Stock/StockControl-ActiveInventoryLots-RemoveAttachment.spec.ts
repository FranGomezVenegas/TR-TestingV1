...
import { RemoveAttachment } from '../../trazit-models/test-config-StockControl-ActiveInventoryLots-RemoveAttachment';
...
const commonTests = () => {
test('Trazit-StockControl-ActiveInventoryLots-RemoveAttachment-Accept', async ({ page }, testInfo) => {
    let afterEachData = {
        textInNotif1:"",
        textInNotif2:"",
        textInNotif3:"",
    ...
    await page.getByText(RemoveAttachment.selectName, {exact: true}).click();
    await page.pause();
    await page.pause();
    await testInfo.attach(RemoveAttachment.screenShotsSelect, {
        body: await page.screenshot({fullPage: true }), 
        contentType: ConfigSettingsAlternative.screenShotsContentType
    });
    await page.pause();
    await page.getByLabel(RemoveAttachment.buttonName, {exact: true}).click();
    await page.pause();
    await page.pause();
    await testInfo.attach(RemoveAttachment.screenShotsEmptyForm, {
      body: await page.screenshot({fullPage: true}),
      contentType: ConfigSettingsAlternative.screenShotsContentType
    });

    
    await page.getByText(RemoveAttachment.selectAttachment, {exact: true}).first().click();
    await page.pause();
    await page.pause();
    await testInfo.attach(RemoveAttachment.screenShotsFilledForm, {
      body: await page.screenshot({ fullPage: true }),
      contentType: ConfigSettingsAlternative.screenShotsContentType
    });
    await page.getByRole('button', { name: RemoveAttachment.buttonAccept }).click();
    await page.pause();
    await page.pause();
    await testInfo.attach(RemoveAttachment.screenShotsAccept, {
      body: await page.screenshot({ fullPage: true }),
      contentType: ConfigSettingsAlternative.screenShotsContentType
    });
  ...
  await test.step('Verify network responses captured', async () => {
    ...
    afterEachData.textInNotif3=RemoveAttachment.textInNotif3
