import { DemoInstruments as modelForTesting} from './demo_instruments';

export const modelConfig={
    procNameLabel: "Instruments control",
    procModel: modelForTesting,    
    tableFilterValue: "testingInstr",
    runNotifMessageCheck: false,
    textInNotif1: "success",
    textInNotif2: "",
    textInNotif3: "",
}

export const xnewInstrumentSuccess={
    viewNameInModel: "PlatformInstruments",
    viewNameOrTextToGet: "Active",
	fldName:{label:"New", value:"Frontend Testing 105"}, 
...
export const xnewInstrumentAlreadyExists={
    viewNameInModel: "PlatformInstruments",
    viewNameOrTextToGet: "Active",
...
export const xdeactivate={
    buttonTitle:"Deactivate",
    tableFilterValueStatic: "Frontend",
    //tableFilterValue: newInstrumentSuccess.fldName.value,
    textInNotif1: "Instrument",
    textInNotif2: "success",
    textInNotif3: "decommissioned",
}

export const xnewInstrumentRegression={
    viewNameInModel: "PlatformInstruments",
    viewNameOrTextToGet: "Active",
