export const Config={
    procNameLabel: "Micro EM"
}

export const logSampleSuccess={
    viewNameInModel: "LogSamples",
    viewNameOrTextToGet: "Active Production Lot", 
    xbuttonName:"LOGSAMPLE",
    xbuttonLabel:"Login",

	filtersInTable: [
		{colName: "Area", colValue:"Llenadora"},		
	], 
    genericFormFields:[
