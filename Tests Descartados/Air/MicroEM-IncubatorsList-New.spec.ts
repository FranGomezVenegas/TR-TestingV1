// // Incubator inc created with success.
...
// import { New } from '../../trazit-models/test-config-MicroEM-IncubatorsList-New';
...
// const commonTests = () => {
//     test('Trazit-WaterMonitoring-IncubatorsList-New-Accept', async ({ page }, testInfo) => {
//         await page.pause();
//         let afterEachData = {
//             textInNotif1:"",
//             textInNotif2:"",
...
//         });
//         await page.pause();
//         await page.getByLabel(New.fldNewIncubName.label).click();
//         await page.pause();
//         await page.pause();
//         await page.getByLabel(New.fldNewIncubName.label).fill(New.fldNewIncubName.value);
//         await page.pause();
//         await page.pause();
//         await page.getByLabel(New.fldIncubStage.label).click();
//         await page.pause();
//         await page.pause();
//         await page.getByRole('option', { name: New.fldIncubStage.option }).click();
//         await page.pause();
//         await page.pause();
...
//         });
//         await page.pause();
//         await page.getByRole('button', { name: New.screenShotsAccept }).click();
//         await page.pause();
//         await page.pause();
...
//     test('Trazit-WaterMonitoring-IncubatorsList-New-Cancel', async ({ page }, testInfo) => {
//         await page.pause();
//         await page.pause();        
//         await page.getByLabel(New.buttonName).click();
//         await page.pause();
...
//         });
//         await page.pause();
//         await page.getByRole('button', { name: New.screenShotsCancel }).click();
//         await page.pause();
//         await page.pause();
