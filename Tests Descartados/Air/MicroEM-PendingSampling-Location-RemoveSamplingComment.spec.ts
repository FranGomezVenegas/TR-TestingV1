...
// import { RemoveSamplingComment } from '../../trazit-models/test-config-MicroEM-PendingSampling-RemoveSamplingComment';;
...
// const commonTests = () => {
//     test('Trazit-MicroEM-PendingSampling-RemoveSamplingComment-Accept', async ({ page }, testInfo) => {
//         await page.pause();
//         let afterEachData = {
//             textInNotif1:"",
//             textInNotif2:"",
