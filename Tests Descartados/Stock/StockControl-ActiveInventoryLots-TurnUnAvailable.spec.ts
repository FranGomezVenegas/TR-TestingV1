...
// import { turnUnAvailable } from '../../trazit-models/test-config-StockControl-ActiveInventoryLots-TryToTurnUnAvailableWhenQualificationNotCompletedYet';
...
// const commonTests = () => {
// test('Trazit-StockControl-ActiveInventoryLots-TurnUnAvailable', async ({ page }, testInfo) => {
//     let afterEachData = {
//         textInNotif1:"",
//         textInNotif2:"",
//         textInNotif3:"",
...
//       const selects =await page.getByText(turnUnAvailable.select, { exact: true });
...
//     await page.pause();
//     await page.pause();
//     await testInfo.attach(turnUnAvailable.screenShotsSelect, {
//         body: await page.screenshot({fullPage: true }), contentType: ConfigSettingsAlternative.screenShotsContentType});  
//     await page.pause();
//     await page.getByTitle(turnUnAvailable.buttonTurnUnAvailable.label).getByRole('img').click();
//     await page.pause();
//     await page.pause();
//     await testInfo.attach(turnUnAvailable.screenResult, {
//         body: await page.screenshot({fullPage: true }), contentType: ConfigSettingsAlternative.screenShotsContentType});
//       await page.pause();
//     await page.pause();
...
//       afterEachData.textInNotif1=turnUnAvailable.textInNotif1
//       afterEachData.textInNotif2=turnUnAvailable.textInNotif2
//       afterEachData.textInNotif3=turnUnAvailable.textInNotif3
...
//         }
//         await testInfo.attach(turnUnAvailable.screenformNotifications, {
//         body: await page.screenshot({ fullPage: true }),
//         contentType: ConfigSettingsAlternative.screenShotsContentType
//         });
//         const notificationDiv = await page.locator(MenuStock.Notification.main.pageElementdiv).first();
//         if (notificationDiv !== null) {
//         await testInfo.attach(turnUnAvailable.screenformLastNotifications, {
