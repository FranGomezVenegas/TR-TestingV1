...
// import { turnAvailable } from '../../trazit-models/test-config-StockControl-ActiveInventoryLots-TryToTurnAvailableWhenQualificationNotCompletedYet';
...
// const commonTests = () => {
// test('Trazit-StockControl-ActiveInventoryLots-TurnAvailable', async ({ page }, testInfo) => {
//     let afterEachData = {
//         textInNotif1:"",
//         textInNotif2:"",
//         textInNotif3:"",
...
//     test.step('Scroll to the select element', async () => {
//       const selects =await page.getByText(turnAvailable.select, { exact: true });

//       await selects.scrollIntoViewIfNeeded();
//   });

//   test.step('Click on the select element', async () => {
//       const selects =await page.getByText(turnAvailable.select, { exact: true });
...
//     await page.pause();
//     await page.pause();
//     await testInfo.attach(turnAvailable.screenShotsSelect, {
//         body: await page.screenshot({fullPage: true }), contentType: ConfigSettingsAlternative.screenShotsContentType});  
    
//     await page.getByTitle(turnAvailable.buttonTurnAvailable.label).getByRole('img').click();
//     await page.pause();
//     await page.pause();
//     await testInfo.attach(turnAvailable.screenResult, {
//         body: await page.screenshot({fullPage: true }), contentType: ConfigSettingsAlternative.screenShotsContentType});
//     await page.pause();
//     //await page.getByRole('button', { name: turnAvailable.buttonAccept.label  }).click();
//     await page.pause();
...
//       afterEachData.textInNotif1=turnAvailable.textInNotif1
//       afterEachData.textInNotif2=turnAvailable.textInNotif2
//       afterEachData.textInNotif3=turnAvailable.textInNotif3
...
//         }
//         await testInfo.attach(turnAvailable.screenformNotifications, {
//         body: await page.screenshot({ fullPage: true }),
//         contentType: ConfigSettingsAlternative.screenShotsContentType
//         });
//         const notificationDiv = await page.locator(MenuStock.Notification.main.pageElementdiv).first();
//         if (notificationDiv !== null) {
//         await testInfo.attach(turnAvailable.screenformLastNotifications, {
