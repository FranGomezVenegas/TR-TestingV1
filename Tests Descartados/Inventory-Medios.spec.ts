...
test('Trazit-Inventory-Medios-Open', async ({ page }) => {
    await page.locator('#procedures').getByText('Procedures').hover();
    await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
    await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
});

test('Trazit-Inventory-Medios-New', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  ...
  await page.getByLabel("lot id").fill("PruebaMedios");
...
test('Trazit-Inventory-Medios-New-Cancel', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByTitle("New").click();
...
test('Trazit-Inventory-Medios-Select', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByText("PruebaMedios").click();
});

test('Trazit-Inventory-Medios-Audit', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByText("PruebaMedios").click();
...
test('Trazit-Inventory-Medios-Unavaliable', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByText("PruebaMedios").click();
...
test('Trazit-Inventory-Medios-Avaliable', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByText("PruebaMedios").click();
...
test('Trazit-Inventory-Medios-Qualification-Cancel', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByText("PruebaMedios").click();
...
test('Trazit-Inventory-Medios-Qualification-Accept', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByText("PruebaMedios").click();
...
test('Trazit-Inventory-Medios-Qualification + Avaliable-Cancel', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByText("PruebaMedios").click();
...
test('Trazit-Inventory-Medios-Qualification + Avaliable-Accept', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByText("PruebaMedios").click();
...
test('Trazit-Inventory-Medios-Consume-Cancel', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByText("PruebaMedios").click();
...
test('Trazit-Inventory-Medios-Consume-Accept', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByText("PruebaMedios").click();
...
test('Trazit-Inventory-Medios-Adjust-Cancel', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByText("PruebaMedios").click();
...
test('Trazit-Inventory-Medios-Adjust-Accept', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByText("PruebaMedios").click();
...
test('Trazit-Inventory-Medios-Add-Cancel', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByText("PruebaMedios").click();
...
test('Trazit-Inventory-Medios-Add-Accept', async ({ page }) => {
  await page.locator('#procedures').getByText('Procedures').hover();
  await page.getByRole('menuitem', { name: 'Inventory Draft' }).click();
  await page.getByRole('menuitem', { name: 'New inventory Lot Medios de Cultivo' }).getByText('New inventory Lot Medios de Cultivo').click();
  await page.getByText("PruebaMedios").click();
