...
import { decision } from '../../trazit-models/test-config-WaterMonitoring-Deviations-Investigations-Decision';
...
const commonTests = () => {
    test('Trazit-WaterMonitoring-Deviations-Investigations-Open', async ({ page }, testInfo) => {
        await page.pause();
    ...
    test('Trazit-WaterMonitoring-Deviations-Investigations-Decision-Accept', async ({ page }, testInfo) => {
        let afterEachData = {
            textInNotif1: "",
            textInNotif2: "",
            textInNotif3: "",
    ...
    test('Trazit-WaterMonitoring-Deviations-Investigations-Decision-Cancel', async ({ page }, testInfo) => {
        await page.getByLabel(decision.buttonInvestigations).click();
        await page.pause();
        await page.pause();
        await testInfo.attach(decision.screenShotsButtonInvestigations, {
