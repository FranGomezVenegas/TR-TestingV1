...
import { AdjustSampleQuantity } from '../../trazit-models/test-config-Lots-View-Summary-LotBulk-AdjustSampleQunatity';
...
const commonTests = () => {
    test('Trazit-LotsView-Search-Summary-AdjustSampleQuantity-Accept', async ({ page }, testInfo) => {
        await page.pause();
        let afterEachData = {
            textInNotif1: "",
            textInNotif2: "",
        ...
        await page.locator(AdjustSampleQuantity.buttonName.locator).getByLabel(AdjustSampleQuantity.buttonName.label).click();
        await page.pause();
        await page.pause();
        await testInfo.attach(AdjustSampleQuantity.screenShotsEmptyForm, {
            body: await page.screenshot({fullPage: true }), 
            contentType: ConfigSettingsAlternative.screenShotsContentType
        });
        await page.getByLabel(AdjustSampleQuantity.fldAdjustSampleQuantity.label).click();
        await page.pause();
        await page.pause();
        await page.getByLabel(AdjustSampleQuantity.fldAdjustSampleQuantity.label).fill(AdjustSampleQuantity.fldAdjustSampleQuantity.value);
        await page.pause();
        await page.pause();
        await testInfo.attach(AdjustSampleQuantity.screenShotsFilledForm, {
            body: await page.screenshot({fullPage: true }), 
            contentType: ConfigSettingsAlternative.screenShotsContentType
        });
        await page.pause();
        await page.getByRole('button', { name: AdjustSampleQuantity.buttonAccept }).click();
        await testInfo.attach(AdjustSampleQuantity.screenShotsAccept, {
            body: await page.screenshot({fullPage: true }), 
            contentType: ConfigSettingsAlternative.screenShotsContentType
        });

        afterEachData.textInNotif1 = AdjustSampleQuantity.textInNotif1;
        afterEachData.textInNotif2 = AdjustSampleQuantity.textInNotif2;
        afterEachData.textInNotif3 = AdjustSampleQuantity.textInNotif3;
        ...
        if (viewportWidth >= 1024) {
            ...
            await testInfo.attach(AdjustSampleQuantity.screenformNotifications, {
                body: await page.screenshot({ fullPage: true }),
                contentType: ConfigSettingsAlternative.screenShotsContentType
            });
            const notificationDiv = await page.locator(MenuInstrumentsControl.Notification.main.pageElementdiv).first();
            if (notificationDiv !== null) {
                await testInfo.attach(AdjustSampleQuantity.screenformLastNotifications, {
    ...
    test('Trazit-LotsView-Search-Summary-AdjustSampleQuantity-Cancel', async ({ page }, testInfo) => {
        await page.pause();
        await page.pause();
        await page.getByLabel(Summary.buttonSummary).click();
        await page.pause();
        ...
        await page.pause();
        await page.getByRole('button', { name: AdjustSampleQuantity.buttonCancel }).click();
        await testInfo.attach(AdjustSampleQuantity.screenShotsCancel, {
            body: await page.screenshot({fullPage: true }), 
            contentType: ConfigSettingsAlternative.screenShotsContentType
        });
    });
