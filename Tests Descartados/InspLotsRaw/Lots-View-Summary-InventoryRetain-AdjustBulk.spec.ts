...
import { AdjustBulkQuantity } from '../../trazit-models/test-config-Lots-View-Summary-InventoryRetain-AdjustBulkQuantity';
...
const commonTests = () => {
    test('Trazit-LotsView-Search-Summary-AdjustBulk-Accept', async ({ page }, testInfo) => {
        await page.pause();
        let afterEachData = {
            textInNotif1: "",
            textInNotif2: "",
        ...
        await page.locator(AdjustBulkQuantity.buttonName.locator).getByLabel(AdjustBulkQuantity.buttonName.label).click();
        await page.pause();
        await page.pause();
        await testInfo.attach(LotsViewSearch.screenShotsEmptyForm, {
            body: await page.screenshot({fullPage: true }), 
            contentType: ConfigSettingsAlternative.screenShotsContentType
        });
        await page.pause();
        await page.getByLabel(AdjustBulkQuantity.fldQuantity.label).click();
        await page.pause();
        await page.pause();
        await page.getByLabel(AdjustBulkQuantity.fldQuantity.label).fill(AdjustBulkQuantity.fldQuantity.value);
        await page.pause();
        await page.pause();
        await page.getByLabel(AdjustBulkQuantity.fldUOM.label, { exact: true }).click();
        await page.pause();
        await page.pause();
        await page.getByLabel(AdjustBulkQuantity.fldUOM.label, { exact: true }).fill(AdjustBulkQuantity.fldUOM.option);
        await page.pause();
        await page.pause();
        await testInfo.attach(AdjustBulkQuantity.screenShotsFilledForm, {
            body: await page.screenshot({fullPage: true }), 
            contentType: ConfigSettingsAlternative.screenShotsContentType
        });
        await page.getByRole('button', { name: AdjustBulkQuantity.buttonAccept }).click();
        await page.pause();
        await page.pause(); 
        await testInfo.attach(AdjustBulkQuantity.screenShotsAccept, {
            body: await page.screenshot({fullPage: true }), 
            contentType: ConfigSettingsAlternative.screenShotsContentType
        });  
        await page.pause();     
        
        afterEachData.textInNotif1 = AdjustBulkQuantity.textInNotif1;
        afterEachData.textInNotif2 = AdjustBulkQuantity.textInNotif2;
        afterEachData.textInNotif3 = AdjustBulkQuantity.textInNotif3;
        ...
        if (viewportWidth >= 1024) {
            ...
            await testInfo.attach(AdjustBulkQuantity.screenformNotifications, {
                body: await page.screenshot({ fullPage: true }),
                contentType: ConfigSettingsAlternative.screenShotsContentType
            });
            const notificationDiv = await page.locator(MenuInstrumentsControl.Notification.main.pageElementdiv).first();
            if (notificationDiv !== null) {
                await testInfo.attach(AdjustBulkQuantity.screenformLastNotifications, {
    ...
    test('Trazit-LotsView-Search-Summary-AdjustBulk-Cancel', async ({ page }, testInfo) => {
        await page.pause();
        await page.pause();
        await page.getByLabel(Summary.buttonSummary).click();
        await page.pause();
        ...
        await page.getByRole('button', { name: AdjustBulkQuantity.buttonCancel }).click();
        await page.pause();
        await page.pause(); 
        await testInfo.attach(AdjustBulkQuantity.screenShotsCancel, {
            body: await page.screenshot({fullPage: true }), 
            contentType: ConfigSettingsAlternative.screenShotsContentType
        });  
        await page.pause();     
