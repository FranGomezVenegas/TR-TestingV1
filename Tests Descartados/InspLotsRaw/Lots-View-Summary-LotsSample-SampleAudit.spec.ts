...
const commonTests = () => {
    test('Trazit-LotsView-Summary-LotsSample-SampleAudit', async ({ page }, testInfo) => {
        await page.pause();
        await page.pause();
        ...
        await page.pause();
        await page.pause();
        await page.getByTitle('Sample Audit').getByLabel('rule').click();
        //await page.locator('#tooltip-83').getByTitle('Sign').locator('slot');
