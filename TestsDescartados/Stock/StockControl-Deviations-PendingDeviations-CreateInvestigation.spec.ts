...
// import { createInvestigation } from '../../trazit-models/test-config-StockControl-Deviantions-CreateInvestigation';
...
// const commonTests = () => {
//     test('Trazit-StockControl-Deviations-PendingDecision-Open', async ({ page }, testInfo) => {
//         await page.pause();
//         await page.getByLabel(createInvestigation.buttonPendingDecision).click();
//         await page.close();
//     });

//     test('Trazit-StockControl-Deviations-PendingDecision-CreateInvestigation', async ({ page }, testInfo) => {
//         let afterEachData = {
//             textInNotif1: "",
//             textInNotif2: "",
//             textInNotif3: "",
...
//         });
//         await page.pause();
//         await page.getByText(createInvestigation.selectLotName).click();
//         await page.pause();
//         await page.pause();
