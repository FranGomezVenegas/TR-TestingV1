...
// import { undecommision } from '../../trazit-models/test-config-instruments-undecommision';
...
// const commonTests = () => {
// test('UnDecommision', async ({page}, testInfo) => {
//     let afterEachData = {
//       textInNotif1:"",
//       textInNotif2:"",
//       textInNotif3:""
...
//     await page.getByLabel(undecommision.buttonTitle).click();
//     await page.pause();
//     await page.pause();
//     await testInfo.attach(undecommision.screenshotsUndecommision, {
//       body: await page.screenshot({ fullPage: true }),
//       contentType: ConfigSettingsAlternative.screenShotsContentType
//     });
//     await page.getByLabel(undecommision.fldNumberOfDays.label).click()
//     await page.getByLabel(undecommision.fldNumberOfDays.label).fill(undecommision.fldNumberOfDays.value);

//     await page.locator(undecommision.reactivateObjectDialog.label).getByLabel(undecommision.reactivateObjectDialog.value).click();
//     await page.pause();
//     await page.pause();
//     await testInfo.attach(undecommision.screenShotsReactivateObjectDialog, {
//       body: await page.screenshot({ fullPage: true }),
//       contentType: ConfigSettingsAlternative.screenShotsContentType
//     });

//     await page.getByRole('button', { name: undecommision.buttonAccept.label }).click();
//     await page.pause();
//     await page.pause();
    
//     await testInfo.attach("Accpt", {
//       body: await page.screenshot({ fullPage: true }),
//       contentType: ConfigSettingsAlternative.screenShotsContentType
//     });
...
//     afterEachData.textInNotif1=undecommision.textInNotif1
//     afterEachData.textInNotif2=undecommision.textInNotif2
//     afterEachData.textInNotif3=undecommision.textInNotif3
...
//       }
//       await testInfo.attach(undecommision.screenformNotifications, {
//       body: await page.screenshot({ fullPage: true }),
//       contentType: ConfigSettingsAlternative.screenShotsContentType
//       });
//       const notificationDiv = await page.locator(MenuInstrumentsControl.Notification.main.pageElementdiv).first();
//       if (notificationDiv !== null) {
//       await testInfo.attach(undecommision.screenformLastNotifications, {
