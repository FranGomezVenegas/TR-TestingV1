...
// import { close } from '../../trazit-models/test-config-StockControl-Deviations-Investigations-Close';
...
// const commonTests = () => {
//     test('Trazit-StockControl-Deviations-Investigations-Close', async ({ page }, testInfo) => {
//         let afterEachData = {
//             textInNotif1: "",
//             textInNotif2: "",
//             textInNotif3: "",
...
//         });
//         await page.pause();        
//         await page.getByLabel(close.buttonName, { exact: true }).dblclick();
//         await page.pause();
//         await page.pause();
