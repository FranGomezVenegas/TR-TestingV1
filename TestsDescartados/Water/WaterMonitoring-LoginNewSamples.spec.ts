...
import { Refresh } from '../../trazit-models/test-config-WaterMonitoring-LoginNewSamples';
import { OpenProcedureWindow } from '../1TRAZiT-Commons/openProcedureWindow';


//Function with all tests.
const commonTests = () => {
  test('Trazit-WaterMonitoring-LoginNewSamples-Open', async ({ page }, testInfo) => {
    await page.pause();
...
test.describe('Desktop Mode', () => {
  test.beforeEach(async ({ page }, testInfo) => {
    ...
    await page.waitForTimeout(3000);
    await openWindow.openWindowForDesktop(page, testInfo, ConfigSettings, platformMenuNames.WaterMonitoring.main, platformMenuNames.WaterMonitoring.LoginNewSamples);
...
test.describe('Mobile mode', () => {
  test.beforeEach(async ({ page }, testInfo) => {
    ...
    const openWindow=new OpenProcedureWindow({page}); 
    await page.waitForTimeout(3000);
    await openWindow.openWindowForMobile(page, testInfo, ConfigSettings, platformMenuNames.WaterMonitoring.mobile, platformMenuNames.WaterMonitoring.LoginNewSamples);    
