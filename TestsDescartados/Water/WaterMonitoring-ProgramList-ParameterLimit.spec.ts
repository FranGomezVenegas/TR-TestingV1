...
import { ParameterList } from '../../trazit-models/test-config-WaterMonitoring-ProgramList-ParameterLimit'; 
...
const commonTests = () => {
    test('Trazit-WaterMonitoring-ProgramList-ParameterLimit-Open', async ({ page }, testInfo) => {
        await page.pause();
        await page.pause();
        await page.getByLabel(ParameterList.buttonName).click();
        await page.pause();
        await page.pause();
        await testInfo.attach(ParameterList.screenShotsParameterLimits, {
