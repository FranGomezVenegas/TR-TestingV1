...
import { CreateInvestigation } from '../../trazit-models/test-config-WaterMonitoring-Deviations-PendingDecision-CreateInvestigation';
...
const commonTests = () => {
    test('Trazit-WaterMonitoring-Deviations-PendingDecision-CreateInvestigation', async ({ page }, testInfo) => {
        let afterEachData = {
            textInNotif1:"",
            textInNotif2:"",
            textInNotif3:"",
        ...
        await page.pause();
        await page.pause();
        await testInfo.attach(CreateInvestigation.screenShotsPendingDecision, {
        ...
        await page.pause();
        await page.pause();
        await testInfo.attach(CreateInvestigation.screenShotsSelectID, {
            body: await page.screenshot({ fullPage: true }),
            contentType: ConfigSettingsAlternative.screenShotsContentType
        });
        await page.getByLabel(CreateInvestigation.buttonCreateInvestigation).click();
        await page.pause();
        await page.pause();
        await testInfo.attach(CreateInvestigation.screenShotsCreateInvestigation, {
            body: await page.screenshot({ fullPage: true }),
            contentType: ConfigSettingsAlternative.screenShotsContentType
        });
        await page.pause();
