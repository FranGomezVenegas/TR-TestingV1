...
// import { ParameterLimits } from '../../trazit-models/test-config-MicroEM-Program-ParameterLimits';
...
// const commonTests = () => {
//     test('Trazit-MicroEM-Program-ParameterList-Open', async ({ page }, testInfo) => {
//       await page.pause();
//       await page.pause();
//       await page.getByLabel(ParameterLimits.buttonName).click();
//       await page.pause();
//       await page.pause();
//       await testInfo.attach(ParameterLimits.screenShotsClickButtonName, {
