...
// const commonTests = () => {
//     test('Trazit-MicroEM-SamplesIncubations-Open', async ({ page }, testInfo) => {
//       await page.pause();
//       await page.pause();
//     });
...
//       await page.waitForTimeout(3000);
//       await openWindow.openWindowForDesktop(page, testInfo, ConfigSettings, MenuMicroEM.MicroEM.main, MenuMicroEM.MicroEM.SamplesIncubations);
...
//       const openWindow=new OpenProcedureWindow({page}); 
//       await page.waitForTimeout(3000);
//       await openWindow.openWindowForMobile(page, testInfo, ConfigSettings, MenuMicroEM.MicroEM.mobile, MenuMicroEM.MicroEM.SamplesIncubations);    
