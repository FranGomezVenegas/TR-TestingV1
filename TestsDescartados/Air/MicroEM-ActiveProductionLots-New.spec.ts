...
// import { NewProductionLots } from '../../trazit-models/test-config-MicroEM-ActiveProductionLots-New';
...
// const commonTests = () => {
//     test('Trazit-MicroEM-ActiveProductionLots-Open', async ({ page }, testInfo) => {
//         await page.pause();
//         await page.pause();
//         //await page.close();
//     })
...
//         await page.getByLabel(NewProductionLots.fldNewProductionLotsName.label).press(NewProductionLots.fldNewProductionLotsName.press);
//         await page.pause();
//         await page.pause();  
//         await page.getByLabel(NewProductionLots.fldNewProductionLotsName.label).fill(NewProductionLots.fldNewProductionLotsName.value); 
//         await page.pause();
//         await page.pause(); 
//         await testInfo.attach(NewProductionLots.screenShotsformFilled, {
//             body: await page.screenshot({fullPage: true }), contentType: ConfigSettingsAlternative.screenShotsContentType});
//         await page.getByRole('button', { name: NewProductionLots.buttonAccept.label }).click();
//         await page.pause();
//         await page.pause();
...
//         }
//         await testInfo.attach(NewProductionLots.screenformNotifications, {
...
//         await testInfo.attach(NewProductionLots.screenformLastNotifications, {
...
//     test('Trazit-MicroEM-ActiveProductionLots-New-Cancel', async ({ page }, testInfo) => {
//         await page.pause();
//         await page.getByLabel(NewProductionLots.buttonNew).click();
//         await page.pause();
//         await page.pause();
...
//         await testInfo.attach(NewProductionLots.screenShotsformFilled, {
//             body: await page.screenshot({fullPage: true }), contentType: ConfigSettingsAlternative.screenShotsContentType});
//         await page.getByRole('button', { name: NewProductionLots.buttonCancel.label }).click();
//         await page.pause();
//         await page.pause();
//         await testInfo.attach(NewProductionLots.screenShotsClickCancel, {
//             body: await page.screenshot({fullPage: true }), contentType: ConfigSettingsAlternative.screenShotsContentType});
//         await page.close();
//         })
// }
