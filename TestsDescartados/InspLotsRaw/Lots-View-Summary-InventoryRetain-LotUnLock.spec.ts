...
import { LotUnLock } from '../../trazit-models/test-config-Lots-View-Summary-InventoryRetain-LotUnLock';
...
const commonTests = () => {
    test('Trazit-LotsView-Summary-InventoryRetain-LotUnLock-Accept', async ({ page }, testInfo) => {
      await page.pause();
        await page.pause();
        ...
        await page.getByTitle(LotUnLock.buttonName.title, { exact: true }).getByLabel(LotUnLock.buttonName.label).click();
        await page.pause();
        await page.pause();
    })
}
