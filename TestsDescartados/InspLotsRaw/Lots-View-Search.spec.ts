...
const commonTests = () => {
    test('Trazit-Lots-LotsView-Open', async ({ page }) => {
        await page.pause();
        await page.pause();
    }),

    
    test('Trazit-Lots-LotsView-Search', async ({ page }, testInfo) => {
        await page.pause();
        await page.pause();
        ...
        await page.pause();
        await page.pause();
        await testInfo.attach(LotsViewSearch.screenShotsFormEmpty, {
