...
import { InventoryRetain } from '../../trazit-models/test-config-Lots-View-InventoryRetain';
...
const commonTests = () => {
    test('Trazit-Lots-LotsView-Search-InventoryRetain', async ({ page }, testInfo) => {
        await page.pause();
        await page.pause();        
        await page.getByLabel(InventoryRetain.buttonInventoryRetain).click();
        await page.pause();
        await page.pause();
        await testInfo.attach(InventoryRetain.screenShotsButtonInventoryRetain, {
