...
import { TakeDecision } from '../../trazit-models/test-config-Lots-View-Summary-InventoryRetain-TakeDecision';
...
const commonTests = () => {
    test('Trazit-LotsView-Summary-InventoryRetain-TakeDecision-Accept', async ({ page }, testInfo) => {
        await page.pause();
        let afterEachData = {
            textInNotif1: "",
            textInNotif2: "",
        ...
        await page.locator(TakeDecision.buttonName.locator).getByLabel(TakeDecision.buttonName.label).click();
        await page.pause();
        await page.pause();
        ...
        await page.pause();
        await page.getByLabel(TakeDecision.fldDecision.label).click();
        await page.pause();
        await page.pause();
        await page.getByRole('option', { name: TakeDecision.fldDecision.option, exact: true }).click();
        await page.pause();
        await page.pause();
    ...
    test('Trazit-LotsView-Summary-InventoryRetain-TakeDecision-Cancel', async ({ page }, testInfo) => {
        await page.pause();
        await page.pause();
        await page.getByLabel(Summary.buttonSummary).click();
        await page.pause();
