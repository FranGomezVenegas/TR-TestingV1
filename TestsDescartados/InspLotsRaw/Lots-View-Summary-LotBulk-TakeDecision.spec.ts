...
import { TakeDecision } from '../../trazit-models/test-config-Lots-View-Summary-LotBulk-TakeDecision';
...
const commonTests = () => {
    test('Trazit-LotsView-Search-Summary-TakeDecision-Accept', async ({ page }, testInfo) => {
        await page.pause();
        let afterEachData = {
            textInNotif1: "",
            textInNotif2: "",
    ...
    test('Trazit-LotsView-Search-Summary-TakeDecision-Cancel', async ({ page }, testInfo) => {
